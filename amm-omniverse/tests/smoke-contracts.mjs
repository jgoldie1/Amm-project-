...
for(const world of ['Gridiron X','Court Kings','Diamond Legends','Ice Storm','World Pitch','Fight Night Holo','StreetVerse','Battlefront Zero','Yogihoo Arena','Volcano Racers','Kingdom Builders']) must(universe.includes(world),`${world} must remain in the 11-world GameVerse`) 
