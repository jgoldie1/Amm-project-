import fs from 'node:fs';import path from 'node:path';const r=p=>fs.readFileSync(path.join(process.cwd(),p),'utf8'),must=(c,s)=>{if(!c)throw new Error(`SERVICE/WORKFORCE SMOKE FAIL: ${s}`)}
