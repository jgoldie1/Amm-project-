...
assert.throws(()=>crawler.plan(source,{urls:['https://news.example.com/news/%2e%2e%2fadmin']}),/CRAWL_ENCODED_PATH_SEPARATOR_PROHIBITED/)
assert.throws(()=>crawler.plan(source,{urls:['https://news.example.com/news/%2E%2E%5Cadmin']}),/CRAWL_ENCODED_PATH_SEPARATOR_PROHIBITED/)
...
assert.match(crawlerSource,/function mappedIpv4\(/)
assert.match(crawlerSource,/CRAWL_ENCODED_PATH_SEPARATOR_PROHIBITED/)
assert.match(crawlerSource,/function normalizedAllowedPathname\(/)
