...
assert.match(endpoint,/allowedQueryKeys=new Set\(\['action','format','location'\]\)/)
assert.match(endpoint,/global_weather_unexpected_query_parameter/)
assert.doesNotMatch(endpoint,/req\.query\?\.region/)
