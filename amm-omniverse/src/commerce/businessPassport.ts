export type BusinessPlanId = 'FREE' | 'STREET_29' | 'COMMERCE_49' | 'EXPERIENCE_499'
...
export const BUSINESS_PLAN_CONTRACT = {
  FREE: { priceUsd: 0, cadence: 'UNSET' },
  STREET_29: { priceUsd: 29, cadence: 'UNSET' },
  COMMERCE_49: { priceUsd: 49, cadence: 'UNSET' },
  EXPERIENCE_499: { priceUsd: 499, cadence: 'UNSET' },
} as const
