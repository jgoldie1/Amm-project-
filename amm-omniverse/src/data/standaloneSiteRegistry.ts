...
export const STANDALONE_SITE_REGISTRY:StandaloneSiteProfile[]=[
  ...
  {slug:'all-american-network',name:'All American Network',tagline:'The TRYAMM media network',description:'The umbrella network connecting Free TV, Isaiah AI TV, StarVerse, LIVE, Reels, StreetVerse coverage and creator publishing.',appPath:'/workstation',capabilities:['Free TV','Isaiah AI TV','StarVerse','LIVE / PK','Reels','StreetVerse coverage','captions','translation','cross-platform sharing','Stubbs AI']},
  {slug:'free-tv',name:'Free TV',tagline:'Free viewing across the TRYAMM network',description:'A planned FAST-style viewer hub for free creator, community, news, music, sports, family and accessibility-first programming. Real channel playback remains feed and rights gated until verified sources are attached.',appPath:'/workstation',capabilities:['FAST-style guide','creator channels','community programming','news','music','sports','family lanes','captions','translation','continue watching']},
  {slug:'isaiah-ai-tv',name:'Isaiah AI TV',tagline:'The AI-assisted media desk for TRYAMM',description:'A media and show-production layer for StreetVerse highlights, StarVerse winners, creator stories, sports, businesses and events, with human publish approval.',appPath:'/workstation',capabilities:['StreetVerse highlights','StarVerse results','creator interviews','sports desk','business spotlight','Reel publishing','captions','translation','human approval']},
  {slug:'starverse',name:'StarVerse — Anyone Can Be a Star',tagline:'Talent, showcases and creator career progression',description:'A talent and showcase experience for auditions, performances, audience feedback, judges, youth safety, creator profiles and media publishing into Isaiah AI TV and OmniReel.',appPath:'/workstation',capabilities:['talent profiles','auditions','showcases','audience voting','judges and hosts','parent/youth safeguards','accessible controls','Isaiah AI TV bridge','OmniReel bridge']},
