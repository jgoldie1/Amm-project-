...
export type StreetVerseAsset={id:string;kind:StreetVerseAssetKind;label:string;url:string;scale?:number;rotationY?:number;district?:string;tags?:string[];fallback?:'primitive'|'hidden';recovered?:boolean;license?:'ORIGINAL'|'LICENSED'|'PLACEHOLDER';provenance?:string}
...
export const STREETVERSE_ASSETS:StreetVerseAsset[]=[
 ...
 {id:'player-hero-v1',kind:'character',label:'StreetVerse Hero Player V1',url:'/assets/streetverse/characters/hero/player-hero-v1.glb',scale:1,fallback:'primitive',tags:['player','hero','photoreal','rigged','lod']},
 ...
 {id:'npc-resident-premium-a',kind:'npc',label:'Premium Resident A',url:'/assets/streetverse/characters/residents/resident-premium-a.glb',scale:1,fallback:'primitive',tags:['resident','premium','photoreal','rigged','lod']},
 {id:'npc-resident-premium-b',kind:'npc',label:'Premium Resident B',url:'/assets/streetverse/characters/residents/resident-premium-b.glb',scale:1,fallback:'primitive',tags:['resident','premium','photoreal','rigged','lod']},
 {id:'npc-resident-premium-c',kind:'npc',label:'Premium Resident C',url:'/assets/streetverse/characters/residents/resident-premium-c.glb',scale:1,fallback:'primitive',tags:['resident','premium','photoreal','rigged','lod']},
 {id:'benny-holographic-host-v1',kind:'character',label:'Benny Holographic OmniHost V1',url:'/assets/streetverse/characters/benny/benny-holographic-host-v1.glb',scale:1,fallback:'primitive',tags:['benny','female','omnihost','hero','holographic-overlay','photoreal','rigged','lod']},
