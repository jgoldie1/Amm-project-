...
export const QUANTUM_GROWTH_LANES:GrowthChannel[]=[
  ...
  {id:'telegram',label:'Quantum Telegram',role:'Opt-in broadcast channels, creator drops, beta-tester groups, multilingual launch alerts, Holo Clip links, bot commands and community funnels.',status:'external-account-required'},
  {id:'whatsapp',label:'Quantum WhatsApp',role:'Opt-in communities and broadcast messaging for creator drops, customer support, launch/tester coordination, multilingual updates, catalog/commerce links and deep links back into TRYAMM.',status:'external-account-required'},
...
export const VIRAL_CONTENT_LOOP=[
  ...
  'whatsapp-opt-in-community-drop',
