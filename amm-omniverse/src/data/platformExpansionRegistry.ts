...
export const REGIONAL_INTEGRATIONS:IntegrationTarget[]=[
  ...
  {id:'qq',label:'QQ',region:'China',category:'Messaging/Community',mode:'research',status:'research'},
  {id:'kakao',label:'KakaoTalk',region:'South Korea',category:'Messaging/Social',mode:'share',status:'wire'},
  {id:'naver',label:'Naver',region:'South Korea',category:'Search/Content',mode:'research',status:'research'},
