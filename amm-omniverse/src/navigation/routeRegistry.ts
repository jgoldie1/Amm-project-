...
export const TRYAMM_ROUTES: TryammRoute[] = [
  ...
  { id:'holo-music', path:'/holo-music', label:'Holo Music', kind:'screen', screen:'music', readiness:'beta' },
  ...
  { id:'holo-menu', path:'/holo-menu', label:'Holo Menu', kind:'overlay', opener:'__showCommandNexus', readiness:'beta' },
