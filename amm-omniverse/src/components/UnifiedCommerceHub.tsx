...
export default function UnifiedCommerceHub(){
 const [open,setOpen]=useState(false);const [lane,setLane]=useState<Lane>('grocery');const [coupon,setCoupon]=useState(false)
