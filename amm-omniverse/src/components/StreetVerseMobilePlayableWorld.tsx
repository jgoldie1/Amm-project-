...
export default function StreetVerseMobilePlayableWorld({onClose}:{onClose:()=>void}){
 ...
 useEffect(()=>{
  ...
  const set=(e:KeyboardEvent,v:boolean)=>{const k=map[e.key.toLowerCase()];if(k){e.preventDefault();held.current[k]=v}}
