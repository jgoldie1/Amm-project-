...
function actions(id:string,level:number){const map:Record<string,string[][]>={
 ...
 'sports-framework':[['Run combine drill','Choose athlete role'],['Follow coach play','Support teammate'],['Execute game plan','Adjust formation'],['Save season result','Build athlete legacy']],
 'living-racing':[['Brake at marker','Hit clean apex'],['Run legal circuit','Avoid penalty'],['Complete sponsor objective','Protect clean result'],['Finalize podium','Save championship legacy']]
