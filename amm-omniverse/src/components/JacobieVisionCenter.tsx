...
export default function JacobieVisionCenter({onClose}:{onClose:()=>void}){
  ...
  const tracks:[Track,string,string][]=[
    ...
    ['real-estate-analysis','Real Estate Analysis','Comps, ARV, rehab, carry, financing and due-diligence analysis; licensed activities stay licensed.'],
