...
const StreetVerseGeoSpawnBridge=lazy(()=>import('./StreetVerseGeoSpawnBridge'))
...
export default function GameVerseLauncher(){
  ...
  if(playStreetVerse)return <Suspense fallback={<div style={{position:'fixed',inset:0,zIndex:18000,background:'#04050e',color:'#fff',display:'grid',placeItems:'center'}}>Loading StreetVerse…</div>}><StreetVerseGeoSpawnBridge onClose={closeStreetVerse}/></Suspense>
  if(!open)return null
