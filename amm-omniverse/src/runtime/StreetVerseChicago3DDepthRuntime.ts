...
export function addChicagoTransitAirportDepth(scene:THREE.Scene){
 ...
 window.dispatchEvent(new CustomEvent('tryamm:streetverse-3d-depth-ready',{detail:{railCars:true,platforms:true,doors:true,crowds:true,visibleFallbackResidents:46,ohare:true,midway:true,physicalChicago:true,animatedFlood:true,rinkSkaters:true,lakefrontPedestrians:true,courthouseCrowds:true,battleTriggers:true,loopTowers:true,riverBridges:true,elevatedL:true,districtArchitecture:['south','west','north'],originalCityArt:originalArt,obamaCenterInspiredCampus:true,obamaCenterMissions:15,obamaLegacyDialogue:true,homeCourtBasketball:true,fictionalPublicEventSecurityMission:true,nativeMultiplayerScene:true}}))
 return {platforms:1,trains:2,riders:46,airports:['O’Hare','Midway'],patrols:4,animatedDoors:doors.length,physicalChicago:true,districtWorld:true,originalCityArt:originalArt,obamaCenterWorld:true,obamaLegacyMissions:true,nativeMultiplayerScene:true}
}