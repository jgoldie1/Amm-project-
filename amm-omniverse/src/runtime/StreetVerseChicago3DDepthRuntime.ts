...
export function addChicagoTransitAirportDepth(scene:THREE.Scene){
 ...
 return {platforms:1,trains:2,riders:46,airports:['O’Hare','Midway'],patrols:4,animatedDoors:doors.length,physicalChicago:true,districtWorld:true,originalCityArt:originalArt,obamaCenterWorld:true,obamaLegacyMissions:true}
}