...
export const STUBBS_FAMILY_MISSIONS:StubbsFamilyMission[]=[
 ...
 {id:'stubbs-raymond-route',characterId:'raymond-jarreau',title:'Hollywood Run',objective:'Complete three fictional Los Angeles entertainment-production objectives connecting creator work, set logistics and Hollywood story missions.',action:'host-creator-event',milestone:'hollywood-connector',minMeetings:1,objectiveTarget:3},
 ...
 {id:'stubbs-tasha-help-chain',characterId:'tasha-ash',title:'San Diego Help Chain',objective:'Complete a fictional San Diego help-chain route by connecting a person in need with trusted support and community resources.',action:'complete-delivery',milestone:'san-diego-help-chain',minMeetings:1,objectiveTarget:3},
 ...
 {id:'stubbs-michael-vegas-connection',characterId:'michael',title:'Sous Chef Shift',objective:'Complete three fictional Las Vegas kitchen and hospitality objectives: prep, service coordination and a successful guest-service closeout.',action:'complete-delivery',milestone:'vegas-sous-chef',minMeetings:1,objectiveTarget:3},
