...
{id:'raymond-jarreau',displayName:'Raymond Jarreau',relationship:'extended-family',roles:['Uncle','Legacy','Los Angeles Story','Hollywood Missions','Insurance','Annuities','401k Education','Infinite Banking Education','Medicaid Navigation'],worlds:['StreetVerse','MeetTheStubbs','TimeMachine','Hollywood'],referencePolicy:'authorized-reference',persistent:true},
...
{id:'tasha-ash',displayName:'Tasha Ash',relationship:'family-connected',roles:['Legacy Ally','Help Chain','San Diego Story','Massage Therapy','Body Sculpting','Sculptify','Staffing','March and Lewis'],worlds:['StreetVerse','MeetTheStubbs','TimeMachine','SanDiego'],referencePolicy:'authorized-reference',persistent:true},
...
{id:'michael',displayName:'Michael',relationship:'friend',roles:['Sous Chef','Food & Hospitality','Las Vegas Story'],worlds:['StreetVerse','MeetTheStubbs','FoodVerse'],referencePolicy:'authorized-reference',persistent:true},
{id:'alphonso',displayName:'Alphonso',relationship:'friend',roles:['CNA Worker','Caregiving','Las Vegas Story'],worlds:['StreetVerse','MeetTheStubbs'],referencePolicy:'authorized-reference',persistent:true},
]
