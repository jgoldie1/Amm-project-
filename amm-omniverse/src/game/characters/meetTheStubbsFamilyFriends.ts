...
{id:'raymond-jarreau',displayName:'Raymond Jarreau',relationship:'extended-family',roles:['Uncle','Legacy','Los Angeles Story','Hollywood Missions'],worlds:['StreetVerse','MeetTheStubbs','TimeMachine','Hollywood'],referencePolicy:'authorized-reference',persistent:true},
...
{id:'tasha-ash',displayName:'Tasha Ash',relationship:'family-connected',roles:['Legacy Ally','Help Chain','San Diego Story'],worlds:['StreetVerse','MeetTheStubbs','TimeMachine','SanDiego'],referencePolicy:'authorized-reference',persistent:true},
