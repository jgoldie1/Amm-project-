...
{id:'michael',displayName:'Michael',relationship:'friend',roles:['StreetVerse','Las Vegas Story'],worlds:['StreetVerse','MeetTheStubbs'],referencePolicy:'authorized-reference',persistent:true},
