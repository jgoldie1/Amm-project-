...
export const INDIANA_LIVING_WORLD = {
  ...
  rules: {
    ...
    chicagoRulesDoNotAutoApply: true,
    stateSpecificCivicAdapterRequired: true,
    realWorldBookingsRequireVerifiedProviders: true,
    teenSafeRouting: true,
  },
} as const
...
export function getIndianaHub(id: string) {
  return INDIANA_LIVING_WORLD.hubs.find(hub => hub.id === id)
}
