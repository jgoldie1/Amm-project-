(()=>{
  ...
  @media (prefers-reduced-motion:reduce){#tryamm-mobile-life *{animation:none!important}.sv-weather{display:none!important}}
  `
  ...
  function mount(){
    ...
    const people=[1,2,3,4,5,6,7].map(i=>`<div class="sv-person p${i}"><div class="head"></div><div class="body"></div><div class="legs"></div></div>`).join('')
    ...
    window.dispatchEvent(new CustomEvent('tryamm:streetverse-mobile-life-ready',{detail:{traffic:4,pedestrians:7,storefronts:3,ambientEvents:1,phase,weather,weatherSource:'simulated-world-weather',reducedMotion:reduceMotion(),npcOnly:true}}))
  }
