-- Mirrors Supabase migration 20260924152921_fix_stripe_allocation_scope_post_merge.
-- Applied after post-merge review found that allocation reconciliation must
-- filter commerce_seller_allocations to the current order before FULL JOIN.
