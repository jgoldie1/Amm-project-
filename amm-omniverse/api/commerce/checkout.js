...
export default async function handler(req,res){
 ...
 try{
   ...
   await adminRest('commerce_orders',{method:'PATCH',query:{id:`eq.${order.id}`,status:'in.(pending_payment,checkout_created)'},body:{status:'checkout_created',payment_provider:'stripe',provider_session_id:session.id,updated_at:new Date().toISOString()}});
