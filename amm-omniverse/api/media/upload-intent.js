...
export default async function handler(req,res){
  ...
  try{
    ...
    const storagePath=objectPath(user.id,fileName),signed=await createSignedUpload(req,storagePath),mediaType=contentType==='image/gif'?'gif':contentType.startsWith('image/')?'image':'reel';
