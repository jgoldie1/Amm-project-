...
export default async function handler(req,res){
  ...
  try{
    ...
    return json(res,200,{ok:true,publication,media:{id:media.id,title:media.title,mediaType:media.media_type},share:{slug:publication.public_slug,path:`/reels/${encodeURIComponent(publication.public_slug)}`}});
