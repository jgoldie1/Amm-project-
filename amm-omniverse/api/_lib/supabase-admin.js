...
export async function adminRest(path,options={}){return adminFetch(path,options)}
export async function adminRpc(functionName,body={}){return adminFetch(`rpc/${encodeURIComponent(functionName)}`,{method:'POST',body})}
