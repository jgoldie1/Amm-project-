...
function compareBrains(primary={},secondary={}){
  const disagreement=[];
  if(primary.answer!==secondary.answer) disagreement.push('answer');
  if(primary.decision!==secondary.decision) disagreement.push('decision');
  ...
  return {agree:disagreement.length===0,disagreement};
}
