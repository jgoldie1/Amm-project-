...
function createSupabaseRest() {
  return { configured, request, insert, upsert, select, patch };
}

module.exports = { configured, request, insert, upsert, select, patch, createSupabaseRest };
