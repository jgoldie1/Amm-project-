      ...
      <main id="main-content" class="portal-main premium-main accessible-main">
        <section class="premium-hero" aria-labelledby="quantum-mail-title">
          <div class="premium-hero-copy">
            ...
            <h1 id="quantum-mail-title">LyonsMail</h1>
            <p>Manage mail accounts, inbox messages, drafts, folders, and linked asset attachments across the platform.</p>
            ${message ? `<p class="ok" role="status">${message}</p>` : ''}
          </div>
        </section>

        <section><table aria-label="LyonsMail Accounts"><thead><tr><th>ID</th><th>Name</th><th>Address</th><th>Type</th><th>Status</th><th>Created</th></tr></thead><tbody>${accountRows || '<tr><td colspan="6">No accounts yet.</td></tr>'}</tbody></table></section>
        <section><table aria-label="LyonsMail Messages"><thead><tr><th>ID</th><th>Owner</th><th>Folder</th><th>Sender</th><th>Recipient</th><th>Subject</th><th>Status</th><th>Created</th></tr></thead><tbody>${messageRows || '<tr><td colspan="8">No messages yet.</td></tr>'}</tbody></table></section>
        <section><table aria-label="LyonsMail Drafts"><thead><tr><th>ID</th><th>Owner</th><th>Recipient</th><th>Subject</th><th>Status</th><th>Created</th></tr></thead><tbody>${draftRows || '<tr><td colspan="6">No drafts yet.</td></tr>'}</tbody></table></section>
        <section><table aria-label="LyonsMail Attachments"><thead><tr><th>ID</th><th>Message ID</th><th>Asset</th><th>Path</th><th>Status</th><th>Created</th></tr></thead><tbody>${attachmentRows || '<tr><td colspan="6">No attachments yet.</td></tr>'}</tbody></table></section>
      </main>
    </div>
  `, user);
}
...
function renderQuantumMailAdminPage(req, user = null, message = '') {
  ...
  return htmlPage('LyonsMail Admin', `
    <a class="skip-link" href="#main-content">Skip to content</a>
    <div class="portal-shell premium-shell accessible-shell">
      ${typeof portalHeader === 'function' ? portalHeader() : ''}
      <main id="main-content" class="portal-main premium-main accessible-main">
        <section class="premium-hero" aria-labelledby="quantum-mail-admin-title">
          <div class="premium-hero-copy">
            ...
            <h1 id="quantum-mail-admin-title">LyonsMail Admin</h1>
            <p>Track folders, mail metrics, and operational visibility for the LyonsMail layer.</p>
            ${message ? `<p class="ok" role="status">${message}</p>` : ''}
          </div>
        </section>

        <section><table aria-label="LyonsMail Folders"><thead><tr><th>ID</th><th>Owner</th><th>Folder</th><th>Type</th><th>Status</th><th>Created</th></tr></thead><tbody>${folderRows || '<tr><td colspan="6">No folders yet.</td></tr>'}</tbody></table></section>
        <section><table aria-label="LyonsMail Metrics"><thead><tr><th>ID</th><th>Metric</th><th>Value</th><th>Scope</th><th>Created</th></tr></thead><tbody>${metricRows || '<tr><td colspan="5">No metrics yet.</td></tr>'}</tbody></table></section>
      </main>
    </div>
  `, user);
}
