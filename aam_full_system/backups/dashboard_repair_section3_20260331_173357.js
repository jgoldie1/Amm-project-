...
if (req.method === 'POST' && pathname === '/studio/create-scene-safe') {
  ...
  return redirectWithMessage(res, '/episode-movie-pipeline', 'Scene created (safe)');
}
...
if (req.method === 'POST' && pathname === '/studio/create-content-safe') {
  ...
  return redirectWithMessage(res, '/creator-tv', 'Content created (safe)');
}
...
if (req.method === 'POST' && pathname === '/studio/create-voice-safe') {
  ...
  return redirectWithMessage(res, '/studio-lab', 'Voice session created (safe)');
}
