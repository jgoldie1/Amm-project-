...
echo "=== CODEX / COPILOT BETA VERIFY ==="
echo
...
echo "[5] Life World"
curl -s http://127.0.0.1:4902/health || exit 1
echo
echo
...
echo "[10] Codex module JSON"
python -m json.tool data/modules/codex_copilot.json >/dev/null && echo "codex_copilot.json OK"
echo

echo "CODEX / COPILOT BETA VERIFY COMPLETE"
