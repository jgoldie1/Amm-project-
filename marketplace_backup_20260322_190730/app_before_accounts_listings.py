...
def ecosystem_map():
    body = """
    <div class="card">
    <h3>All American Marketplace Ecosystem Map</h3>
    <ul>
    <li>Marketplace Economy</li>
    <li>El Saturn FinBank</li>
    <li>El Saturn International Bank</li>
    <li>Bank of Yahavah</li>
    <li>University System</li>
    <li>AI Center / Jarvis</li>
    <li>Call Center + Work From Home</li>
    <li>Streaming Ecosystem</li>
    <li>Aniyah App</li>
    <li>Aniyah Voice Coach</li>
    <li>Jacobie Vision</li>
    <li>Isaiah AI TV</li>
    <li>Kevon Shot It</li>
    <li>Alton Security</li>
    <li>Metaverse</li>
    <li>Middleverse</li>
    <li>Multiverse</li>
    </ul>
    ...
    <ul>
    <li>Connects education, work, and finance</li>
    <li>Supports creators and media businesses</li>
    <li>Provides AI guidance and automation</li>
    <li>Supports remote work and employment</li>
    <li>Creates digital worlds for operations</li>
    <li>Integrates faith stewardship and commerce</li>
    </ul>
    </div>
    """
    return page("Ecosystem Map", body)
