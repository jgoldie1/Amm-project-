...
def stability_center():
    body = """
    <div class="hero">
      <h1 style="margin:0 0 8px 0;">Stability Center</h1>
      <p style="margin:0;">Central page for hardened startup, audits, and safe operation.</p>
    </div>
    ...
    <div class="card">
      <div class="grid">
        ...
        <a class="smallbtn" href="/route-map">Route Map</a>
        <a class="smallbtn" href="/time-machine">Time Machine</a>
        <a class="smallbtn" href="/creator-links">Creator Links</a>
      </div>
    </div>
    """
    return _brand_shell("Stability Center", body)
