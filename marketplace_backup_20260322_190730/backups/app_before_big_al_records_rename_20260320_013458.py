...
def alton_stubbs_heir():
    ...
    conn = sqlite3.connect("instance/app.db")
    conn.row_factory = sqlite3.Row
    heir = conn.execute("SELECT * FROM heir_profiles WHERE full_name = 'Alton Stubbs' LIMIT 1").fetchone()
    conn.close()
    ...
    body = f"""
    <div class="hero">
      <h1>Alton Stubbs Heir Profile</h1>
      <p>{hero_note}</p>
      <div class="badges">
    ...
    <div class="grid">
      ...
      <div class="card"><h2>Alton Records</h2><p>Artist development, releases, label support, and streaming-linked promotion.</p><a class="btn" href="/alton-records">Open</a></div>
      <div class="card"><h2>Notes</h2><p>{notes}</p></div>
    </div>
    """
    if 'minimal_shell' in globals():
        return minimal_shell("Alton Stubbs Heir", body)
    if 'cinematic_shell' in globals():
        return cinematic_shell("Alton Stubbs Heir", body)
    return body
...
def alton_records():
    ...
    """
    if 'minimal_shell' in globals():
        return minimal_shell("Alton Records", body)
    if 'cinematic_shell' in globals():
        return cinematic_shell("Alton Records", body)
    return body
...
def aame_alton_kevon_hub():
    ...
    <div class="hero">
      ...
      <p>This hub connects Alton Stubbs heir divisions and Kevon divisions into the All American Marketplace Holographic Streaming Ecosystem as one operational, media, compliance, and finance-linked platform.</p>
      <div class="cta-row">
    ...
    <div class="grid">
      ...
      <div class="card"><h2>Alton Records</h2><p>Connects artist development, releases, music, and streaming promotion.</p><a class="btn" href="/alton-records">Open</a></div>
