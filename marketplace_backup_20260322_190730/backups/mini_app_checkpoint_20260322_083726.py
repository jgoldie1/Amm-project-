...
def metaverse_webgl():
    ...
    <div class="card">
      ...
      <div style="display:flex;gap:8px;flex-wrap:wrap;">
        <button id="touch-up" onclick="move('w')">Up</button>
        <button id="touch-left" onclick="move('a')">Left</button>
        <button id="touch-down" onclick="move('s')">Down</button>
        <button id="touch-right" onclick="move('d')">Right</button>
      </div>
