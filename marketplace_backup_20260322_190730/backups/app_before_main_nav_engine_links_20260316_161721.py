...
def verse_center():
    ...
    body += """
    <div class="card">
        <h3>World and OASIS Links</h3>
        <a class="btn" href="/oasis-center">OASIS Center</a>
        <a class="btn" href="/living-oasis-center">Living OASIS</a>
        <a class="btn" href="/world-blueprint-center">World Blueprints</a>
        <a class="btn" href="/world-instructions">World Instructions</a>
        <a class="btn" href="/ai-world-builder">AI World Builder</a>
        <a class="btn" href="/scene-generator">Scene Generator</a>
        <a class="btn" href="/realtime-world-engine">World Engine</a>
        <a class="btn" href="/immersive-map-viewer">Immersive Map</a>
        <a class="btn" href="/world-minimap">World Minimap</a>
        <a class="btn" href="/transport-hub">Transport Hub</a>
    </div>
    """
body += section("What This Does", [
...
def command_center():
    ...
    <div class="card">
        ...
        <a class="btn" href="/immersive-map-viewer">Immersive Map</a>
        <a class="btn" href="/world-minimap">World Minimap</a>
        <a class="btn" href="/avatar-movement">Avatar Movement</a>
        <a class="btn" href="/multiplayer-presence-list">Presence List</a>
        <a class="btn" href="/creator-world-builder-ui">World Builder UI</a>
        <a class="btn" href="/webgl-canvas-viewer">WebGL Viewer</a>
        <a class="btn" href="/live-avatar-preview">Avatar Preview</a>
        <a class="btn" href="/world-zone-loading">Zone Loading</a>
        <a class="btn" href="/heatmap-visualization">Heatmap</a>
        <a class="btn" href="/object-ownership-inspector">Ownership Inspector</a>
        <a class="btn" href="/ticket-gate-validator">Ticket Validator</a>
        <a class="btn" href="/transport-hub">Transport Hub</a>
    </div>
    """
body += section("What This Does", [
...
def oasis_center():
    ...
    body += """
    <div class="card">
        <h3>Living World Systems</h3>
        <a class="btn" href="/vip-access-center">VIP Access</a>
        <a class="btn" href="/avatar-customization-studio">Avatar Studio</a>
        <a class="btn" href="/city-zoning-engine">City Zoning</a>
        <a class="btn" href="/vehicle-animal-systems">Vehicle + Animal Systems</a>
        <a class="btn" href="/event-gate-logic">Event Gate Logic</a>
        <a class="btn" href="/trust-zone-manager">Trust Zones</a>
        <a class="btn" href="/world-heatmap-dashboard">World Heatmap</a>
        <a class="btn" href="/creator-asset-placement">Creator Asset Placement</a>
        <a class="btn" href="/living-oasis-center">Living OASIS</a>
        ...
        <a class="btn" href="/access-badge-scanner">Badge Scanner</a>
        <a class="btn" href="/inheritance-permissions">Inheritance</a>
        <a class="btn" href="/world-pass-wallet">World Pass Wallet</a>
        <a class="btn" href="/zone-economy-manager">Zone Economy</a>
