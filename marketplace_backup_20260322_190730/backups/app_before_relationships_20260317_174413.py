...
def app_home():
    ...
    <div class="card">
      ...
      <a class="btn" href="/ecosystem-brand"
        ...
        <a class="smallbtn" href="/creator-dashboard">Creator Dashboard</a>
        <a class="smallbtn" href="/creator-dashboard-live">Live Creator Dashboard</a>>Open Brand Showcase</a>
    </div>
...
def payments_shell():
    ...
    <div class="card">
      ...
      <div class="grid">
        ...
        <a class="smallbtn" href="/creator-onboarding">Become Creator</a>
        <a class="smallbtn" href="/creator-dashboard">Creator Dashboard</a>
        <a class="smallbtn" href="/creator-dashboard-live">Live Creator Dashboard</a>>Brand Showcase</a>
        <a class="smallbtn" href="/jarvis-workflows">Workflows</a>
        <a class="smallbtn" href="/app-home">App Home</a>
      </div>
    </div>
...
def metaverse_featured():
    ...
    <div class="card">
      ...
      <div class="grid">
        ...
        <a class="smallbtn" href="/creator-onboarding">Become Creator</a>
        <a class="smallbtn" href="/creator-dashboard">Creator Dashboard</a>
        <a class="smallbtn" href="/creator-dashboard-live">Live Creator Dashboard</a>>Brand Layer</a>
      </div>
    </div>
    """
...
def creator_dashboard():
    ...
    <div class="card">
      ...
      <div class="grid">
        ...
        <a class="smallbtn" href="/creator-launchpad">Launchpad</a>
...
def creator_directory():
    try:
        ...
        cards = "".join(
            ...
            <div class='tile'>
              <h3>{r.name}</h3>
              <p>{r.niche or 'Creator'}</p>
              <a class='smallbtn' href='/creator-storefront/{r.id}'>Open Storefront</a>
              <a class='smallbtn' href='/edit-creator-db/{r.id}'>Edit Profile</a>
            </div>
            """
            for r in rows
        ) or "<p>No creators yet.</p>"
    except Exception as e:
        cards = f"<p>DB error: {e}</p>"

    body = f"""
    <div class="hero">
      <h1 style="margin:0 0 8px 0;">Creator Directory</h1>
      <p style="margin:0;">Browse creators across the ecosystem.</p>
    </div>
    ...
    <div class="card">
      <a class="btn" href="/create-creator-db">Add Creator</a>
      <a class="btn" href="/creator-dashboard-live">Open Creator Dashboard Live</a>
    </div>
    """
    return _brand_shell("Creator Directory", body)

@app.route("/creator-storefront/<int:creator_id>")
def creator_storefront(creator_id):
    try:
        with app.app_context():
            db.create_all()
        creator = CreatorRecord.query.get(creator_id)
        if not creator:
            return _brand_shell("Creator Storefront", "<div class='card'><p>Creator not found.</p><a class='btn' href='/creator-directory'>Back</a></div>")

        # current simple phase: show all products/content until creator-linked ownership is added later
        products = ProductRecord.query.order_by(ProductRecord.id.desc()).limit(6).all()
        ...
        <div class="card">
          <h2 class="sectiontitle">Creator Actions</h2>
          <div class="grid">
        ...
        <div class="card">
          <h2 class="sectiontitle">World Access</h2>
          <div class="grid">
            <a class="smallbtn" href="/metaverse-hub">Metaverse</a>
            <a class="smallbtn" href="/streaming-hub">Streaming</a>
            <a class="smallbtn" href="/holoverse-hub">Holoverse</a>
            <a class="smallbtn" href="/memory-journey">Memory Journey</a>
          </div>
        </div>
        """
        return _brand_shell(f"{creator.name} Storefront", body)
    except Exception as e:
        return _brand_shell("Creator Storefront", f"<div class='card'><p>DB error: {e}</p></div>")

@app.route("/creator-launchpad")
def creator_launchpad():
    body = """
    <div class="hero">
      <h1 style="margin:0 0 8px 0;">Creator Launchpad</h1>
      <p style="margin:0;">Start, manage, and publish creator-facing experiences.</p>
    </div>

    <div class="card">
      <div class="grid">
        <a class="smallbtn" href="/creator-onboarding">Onboarding</a>
        <a class="smallbtn" href="/creator-dashboard">Creator Dashboard</a>
        <a class="smallbtn" href="/creator-dashboard-live">Live Creator Dashboard</a>
    ...
    <div class="card">
      <a class="btn" href="/create-creator-db">Create New Creator Record</a>
    </div>
    """
    return _brand_shell("Creator Launchpad", body)
