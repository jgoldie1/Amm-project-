...
def family_launch_home():
    ...
    <div class="bday-banner"><h2>🎉 Happy Birthday Aniyah</h2><p>Birthday spotlight is live now. Alton Kevon countdown is 3 days away.</p><div class="cta-row"><a class="btn" href="/birthday-center">Open Birthday Center</a><a class="btn-secondary" href="/happy-birthday-aniyah">Aniyah Page</a></div></div><div class="bday-banner"><h2>🎉 Happy Birthday Aniyah</h2><p>Birthday spotlight is live now. Alton Kevon countdown is 3 days away.</p><div class="cta-row"><a class="btn" href="/birthday-center">Open Birthday Center</a><a class="btn-secondary" href="/happy-birthday-aniyah">Aniyah Page</a></div></div><div class="section-title">Start here</div>
    <div class="quick">
      <a href="/heirs-app">Heirs App</a>
      <a href="/heirs-launchpad">Launchpad</a>
...
@app.route("/api/birthday-events-v1")
def api_birthday_events_v1():
    import sqlite3
    conn = sqlite3.connect("instance/app.db")
    conn.row_factory = sqlite3.Row
    rows = conn.execute("SELECT * FROM birthday_events_v1 ORDER BY id").fetchall()
    conn.close()
    return jsonify([dict(r) for r in rows])

@app.route("/api/birthday-nfts-v1")
def api_birthday_nfts_v1():
    import sqlite3
    conn = sqlite3.connect("instance/app.db")
    conn.row_factory = sqlite3.Row
    rows = conn.execute("SELECT * FROM birthday_nfts_v1 ORDER BY id").fetchall()
    conn.close()
    return jsonify([dict(r) for r in rows])
    ...
    <body>
      <div class="shell">
        <div class="hero">
          ...
          <p>Special birthday celebrations, countdowns, and keepsake NFT concepts for the family app.</p>
        </div>

        <div class="bday-banner">
          <h2>🎉 Happy Birthday Aniyah 🎉</h2>
          <p>Welcome to your birthday spotlight inside the family app.</p>
          <div class="cta-row">
            <a class="btn" href="/happy-birthday-aniyah">Open Birthday Page</a>
            <button class="btn-secondary" onclick="singAniyah()">Sing Happy Birthday</button>
          </div>
        </div>
        ...
        <div class="bday-grid">
          ...
          <div class="bday-card">
            <h2>Birthday NFT Gallery</h2>
            <p>Birthday keepsake NFT shells for family celebration moments.</p>
            <a class="btn" href="/birthday-nft-gallery">Open</a>
          </div>
          <div class="bday-card">
            <h2>Birthday Data</h2>
            <p>Open events and NFT concept data.</p>
            <a class="btn-secondary" href="/api/birthday-events-v1">Events</a>
            <a class="btn-secondary" href="/api/birthday-nfts-v1">NFTs</a>
          </div>
        </div>
      </div>
      ...
      <script>
      function singAniyah() {
        const msg = new SpeechSynthesisUtterance("Happy Birthday to you. Happy Birthday dear Aniyah. Happy Birthday to you.");
    ...
    <body>
      <div class="shell">
        <div class="bday-banner">
          ...
          <p>This is your special birthday spotlight page inside the family app.</p>
          <div class="cta-row">
            <button class="btn" onclick="singAniyah()">Sing Happy Birthday</button>
            <a class="btn-secondary" href="/birthday-nft-gallery">See Birthday NFT</a>
          </div>
        </div>
      </div>
      <script>
    ...
    <body>
      <div class="shell">
        <div class="bday-banner">
          ...
          <p>The app is counting down to his special birthday spotlight.</p>
        </div>
      </div>
    </body>
    </html>
