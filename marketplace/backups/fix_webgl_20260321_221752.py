...
def metaverse_webgl():
    ...
    <div class="card">
      <h2>Touch Joystick</h2>
      <div style="display:flex;gap:8px;flex-wrap:wrap;">
        <button id="joyUp">Up</button>
        <button id="joyLeft">Left</button>
        <button id="joyDown">Down</button>
        <button id="joyRight">Right</button>
      </div>
      <p><small>Use this on mobile if keyboard controls are not convenient.</small></p>
    </div>
    ...
    (function () {{
      ...
      makeLabel('Marketplace', -6, -4);
      makeLabel('Streaming', 0, -7);
      makeLabel('Creator', 6, -4);
      makeLabel('Ecosystem', -4, 5);
      makeLabel('University', 4, 5);
