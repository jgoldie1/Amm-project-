...
def app_home():
    ...
    <div class="card">
      ...
      <a class="btn" href="/ecosystem-brand">Open Brand Showcase</a>
    </div>
...
def payments_shell():
    ...
    <div class="card">
      ...
      <div class="grid">
        ...
        <a class="smallbtn" href="/ecosystem-brand">Brand Showcase</a>
        <a class="smallbtn" href="/jarvis-workflows">Workflows</a>
        <a class="smallbtn" href="/app-home">App Home</a>
      </div>
    </div>
...
def verse_overview():
    ...
    <div class="triple">
      <div class="tile">
        ...
        <a class="smallbtn" href="/metaverse-hub">Open Metaverse</a>
      </div>
      <div class="tile">
        <h3>Middleverse</h3>
        <p>Workflow bridge and controlled operations layer.</p>
        <a class="smallbtn" href="/middleverse-hub">Open Middleverse</a>
      </div>
      <div class="tile">
        <h3>Multiverse</h3>
        <p>Expanded world network and premium realm layer.</p>
        <a class="smallbtn" href="/multiverse-hub">Open Multiverse</a>
      </div>
    </div>
