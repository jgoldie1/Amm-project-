...
def metaverse_webgl():
    ...
    <div class="card">
      ...
      <p>This is the first real WebGL scene for your metaverse, middleverse, and multiverse system.</p>
      <p><small>If the 3D scene is blank, the browser may not have internet access to load Three.js from CDN. Your /metaverse-3d page still remains as fallback.</small></p>
    </div>
    ...
    <div class="grid">
      <div class="card"><h2>Portals</h2><a href="/world/Marketplace">Marketplace</a><a href="/world/Streaming Studio">Streaming</a><a href="/world/Creator Arena">Creator</a></div>
      <div class="card"><h2>Ecosystem</h2><a href="/aam-holographic-streaming-ecosystem">AAM Ecosystem</a><a href="/aam-university">AAM University</a></div>
      <div class="card"><h2>Fallback</h2><a href="/metaverse-3d">Open 3D Prototype</a><a href="/holoverse-lobby-v2">Back to Holoverse</a></div>
    </div>
    ...
    (function () {
      ...
      const floorMat = new THREE.MeshStandardMaterial({ color: 0x0f766e, roughness: 0.9, metalness: 0.1 });
      const floor = new THREE.Mesh(floorGeo, floorMat);
      floor.rotation.x = -Math.PI / 2;
      scene.add(floor);

      const grid = new THREE.GridHelper(30, 30, 0x60a5fa, 0x334155);
      scene.add(grid);
      ...
      const p1 = makePortal(0x2563eb, -4, -2);
      const p2 = makePortal(0x7c3aed, 0, -4);
      const p3 = makePortal(0xdb2777, 4, -2);
      const p4 = makePortal(0x0891b2, -2, 3);
      const p5 = makePortal(0x16a34a, 2, 3);

      scene.add(p1, p2, p3, p4, p5);
      ...
      for (let i = 0; i < starCount; i++) {
        ...
        positions.push(Math.random() * 50 + 5);
        positions.push((Math.random() - 0.5) * 100);
      }
