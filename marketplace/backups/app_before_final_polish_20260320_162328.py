...
def family_launch_home():
    crest = _fivepm_brand("stubbs_crest_real") or _fivepm_brand("stubbs_crest")
    saturn = _fivepm_brand("saturn_real") or _fivepm_brand("el_saturn") or _fivepm_brand("saturn")
    flag = _fivepm_brand("american_flag_real") or _fivepm_brand("american_flag_holo") or _fivepm_brand("american_flag")
    lion = _fivepm_brand("lion_real") or _fivepm_brand("holographic_lion_saturn")

    body = f"""
    <div class="hero">
      <h1>Family Launch Home</h1>
      <p>This is the clean 5pm version for your kids and Alton Kevon to use first. It keeps the experience simple, clear, and easy to navigate.</p>
      <div class="badges">
        <span class="badge">Private Family Beta</span>
        <span class="badge">Heirs First</span>
        <span class="badge">Simple Navigation</span>
        <span class="badge">Media + World + Commerce</span>
      </div>
      <div class="cta-row">
        <a class="btn" href="/heirs-app">Open Heirs App</a>
        <a class="btn-secondary" href="/media-demo-home">Open Media Demo</a>
      </div>
      <div class="notice">Today’s goal is a clean family-first beta, not full production completion.</div>
    </div>

    <div class="brand-row">
      <div class="brand-box"><h3>Stubbs Crest</h3><img src="{crest}" alt="Stubbs Crest"></div>
      <div class="brand-box"><h3>Saturn</h3><img src="{saturn}" alt="Saturn"></div>
      <div class="brand-box"><h3>American Flag</h3><img src="{flag}" alt="American Flag"></div>
      <div class="brand-box"><h3>Lion</h3><img src="{lion}" alt="Lion"></div>
    </div>

    <div class="bday-banner"><h2>🎉 Happy Birthday Aniyah</h2><p>Birthday spotlight is live now. Alton Kevon countdown is 3 days away.</p><div class="cta-row"><a class="btn" href="/birthday-center">Open Birthday Center</a><a class="btn-secondary" href="/birthday-nft-gift-center">Gift Birthday NFT</a><a class="btn-secondary" href="/happy-birthday-aniyah">Aniyah Page</a></div></div><div class="bday-banner"><h2>🎉 Happy Birthday Aniyah</h2><p>Birthday spotlight is live now. Alton Kevon countdown is 3 days away.</p><div class="cta-row"><a class="btn" href="/birthday-center">Open Birthday Center</a><a class="btn-secondary" href="/birthday-nft-gift-center">Gift Birthday NFT</a><a class="btn-secondary" href="/happy-birthday-aniyah">Aniyah Page</a></div></div><div class="section-title">Start here</div>
    <div class="quick">
      <a href="/heirs-app">Heirs App</a>
      <a href="/heirs-launchpad">Launchpad</a>
      <a href="/media-demo-home">Media Demo</a>
      <a href="/holoverse-lobby-v2">Holoverse</a>
      <a href="/holo-commerce-home">Commerce</a>
      <a href="/report-center">Report Issues</a>
    </div>

    <div class="section-title">Main sections</div>
    <div class="grid">
      <div class="card"><h2>Media</h2><p>Shows, music, creator clips, and recording/coaching entry points.</p><a class="btn" href="/media-demo-home">Open</a></div>
      <div class="card"><h2>World</h2><p>Holoverse lobby, teleport center, and future open-world region hubs.</p><a class="btn" href="/holoverse-lobby-v2">Open</a></div>
      <div class="card"><h2>Commerce</h2><p>Holographic storefront, live shopping, drops, and discovery.</p><a class="btn" href="/holo-commerce-home">Open</a></div>
      <div class="card"><h2>Creator Tools</h2><p>Uploads, bookings, releases, and workflow shells.</p><a class="btn" href="/creator-tools-home">Open</a></div>
    </div>
    """
    return fivepm_shell("Family Launch Home", body)
