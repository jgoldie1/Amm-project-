...
def app_home():
    ...
    <div class="hero hero-center">
      <h1>All American Marketplace</h1>
      <p>Flagship platform operating system for commerce, Holoverse, finance, media, education, AI, and advanced ecosystem control.</p>
      <div class="hero-badges">
        <span class="pill">Flagship App</span>
        <span class="pill">Holoverse Ready</span>
        <span class="pill">Finance + AI + Media</span>
      </div>
      <div class="brandbar">
      ...
      <div class="button-row" style="justify-content:center;margin-top:20px">
        ...
        <a class="btn-secondary" href="/control-tower">Open Control Tower</a>
      </div>
    </div>

    <div class="grid">
      <div class="card"><h2>Flagship Showcase</h2><p>Premium branded presentation of the platform identity and direction.</p><a class="btn" href="/flagship-showcase">Open</a></div>
      <div class="card"><h2>Live Status</h2><p>Quick visual board for what is currently live and working.</p><a class="btn" href="/live-status-board">Open</a></div>
      <div class="card"><h2>Feature Radar</h2><p>See what is built, partial, and still needs hardening.</p><a class="btn" href="/feature-radar">Open</a></div>
      <div class="card"><h2>Search UI</h2><p>Cross-module search across the full ecosystem.</p><a class="btn" href="/search-ui">Open</a></div>
      <div class="card"><h2>Media Studio</h2><p>Music, streaming, uploads, and creative assets.</p><a class="btn" href="/media-studio">Open</a></div>
      <div class="card"><h2>FinBank</h2><p>International finance shell and control layer.</p><a class="btn" href="/finbank-international">Open</a></div>
    </div>
    """ + flagship_dock()
    return app_shell("AAME App Home", body)
...
def upload_studio():
    ...
    status_html = ""
    if status == "uploaded":
        status_html = '<p class="success">Upload saved successfully.</p>'
    elif status == "missing_file":
        status_html = '<p class="warn">Please choose a file first.</p>'

    body = f"""
    <div class="shell">
      <div class="hero">
        <h1>Upload Studio</h1>
        <p>Upload images, video, audio, and files into the flagship creator asset system.</p>
        <div class="badges">
          <span class="badge">Images</span>
          <span class="badge">Video</span>
          <span class="badge">Audio</span>
          <span class="badge">Creator Assets</span>
        </div>
      </div>

      <div class="navline">
        <a href="/app-home">App Home</a>
        <a href="/media-studio">Media Studio</a>
        <a href="/search-ultra">Search Ultra</a>
      ...
      <div class="layout">
        <div class="panel">
          <h2>New Upload</h2>
          {status_html}
          <form class="upload-box" action="/upload-creator-asset" method="post" enctype="multipart/form-data">
        ...
        <div class="panel">
          ...
          <p>It gives the platform a real local upload path so you can start seeing images, video, audio, and files in your own app instead of only seeded data.</p>
...
def search_ultra():
    ...
    <div class="shell">
      <div class="hero">
        <h1>Search Ultra</h1>
        <p>Flagship search engine surface for marketplace, wallet, music, streaming, vocal sessions, payments, media assets, uploaded files, AI workflows, and live modules.</p>
        <div class="badges">
          <span class="badge">Cross-Module Search</span>
          <span class="badge">Media Previews</span>
          <span class="badge">Flagship UI</span>
        </div>
      </div>
      ...
      <div class="navline">
        <a href="/app-home">App Home</a>
        <a href="/holoverse-center">Holoverse</a>
        <a href="/upload-studio">Upload Studio</a>
        <a href="/flagship-ai-suite">AI Suite</a>
      </div>

      <div class="toolbar">
        <input id="q" placeholder="Search everything: music, wallet, Aniyah, kingdom, upload, lion, stream...">
        ...
        <button onclick="runUltraSearch()">Run Search</button>
      </div>
      ...
      <div class="layout">
        <div class="panel">
          ...
          <p class="muted">Aniyah</p>
          <p class="muted">lion</p>
          <p class="muted">brand</p>
          <p class="muted">stream</p>
        </div>
        <div class="panel">
          <h2>Live Results</h2>
          <p class="muted">This engine now searches uploaded assets too.</p>
    ...
    function renderPreview(r) {
      ...
      if ((source === "creator_uploads" || source === "media_assets") && filename) {
        ...
        if (fileType === "image" || /\\.(png|jpg|jpeg|gif|webp|svg)$/i.test(filename)) {
          return `<img class="preview" src="${src}" alt="${r.title || r.asset_title || "preview"}">`;
        }
        ...
        if (fileType === "audio" || /\\.(mp3|wav|ogg|m4a)$/i.test(filename)) {
          return `<audio style="width:100%;margin-top:10px" controls src="${src}"></audio>`;
        }
      }
    ...
    async function runUltraSearch() {
      ...
      if (sourceFilter) {
        results = results.filter(r => (r._source || "") === sourceFilter);
      }
      if (typeFilter) {
        results = results.filter(r => (r.file_type || "") === typeFilter);
      }

      if (!results.length) {
        box.innerHTML = '<div class="card"><h3>No results found</h3><p>Try another keyword or remove filters.</p></div>';
        return;
      }
...
def creator_market():
    ...
    <head>
      ...
      <link rel="stylesheet" href="/static/css/ultra_search.css">
    </head>
    <body>
      <div class="shell">
        <div class="hero">
          <h1>Creator Market</h1>
          <p>Flagship creator asset surface for visuals, video, audio, uploads, brand assets, and future creator commerce.</p>
          <div class="badges">
        ...
        <div class="panel" style="margin-top:18px">
          <h2>Next step</h2>
          <p>This is the base for a more premium creator marketplace experience without cloning another interface.</p>
        </div>
      </div>
    </body>
    </html>
