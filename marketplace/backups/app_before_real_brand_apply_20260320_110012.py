...
def full_app_showcase():
    crest = _brand_asset_url_show("stubbs_crest_real") or _brand_asset_url_show("crest")
    flag = _brand_asset_url_show("american_flag_real") or _brand_asset_url_show("flag")
    saturn = _brand_asset_url_show("saturn_real") or _brand_asset_url_show("saturn")
    lion = _brand_asset_url_show("lion_real") or _brand_asset_url_show("lion")
...
def brand_test():
    ...
    <head>
      ...
      <style>
        ...
        body::before, body::after{
          ...
          opacity:.22;
          pointer-events:none;
          background-image:url('/static/img/holographic_lion_saturn.svg');
    ...
    <body>
      <div class="wrap">
        <div class="hero">
          <h1>Brand Test</h1>
          <p>This page directly loads the crest, flag, Saturn, and lion assets.</p>
        </div>

        <div class="grid">
          <div class="card">
            <h2>Stubbs Crest</h2>
            <img src="/static/brand/stubbs_crest_real.svg" alt="Stubbs Crest">
          </div>
          <div class="card">
            <h2>American Flag</h2>
            <img src="/static/brand/american_flag_real.svg" alt="American Flag">
          </div>
          <div class="card">
            <h2>Saturn</h2>
            <img src="/static/brand/saturn_real.svg" alt="Saturn">
          </div>
          <div class="card">
            <h2>Holographic Lion</h2>
            <img src="/static/brand/lion_real.svg" alt="Lion">
          </div>
        </div>
      </div>
    </body>
