...
flagship_products = [
    ...
    },
    {
        "name": "Flagship Three",
        "type": "core",
        "summary": "Editable third flagship until final product is confirmed."
    },
]
...
# ===== HOLOGRAPHIC ENGINE FOUNDATION =====

@app.route("/holo-engine")
def holo_engine():
    body = """
    <style>
      canvas{
    ...
    <div class="hero">
      ...
      <p>WebGL-ready holographic rendering layer (foundation stage)</p>
    </div>
    ...
    """
    return _ultra_shell("Holographic Engine", body)

# ===== GAME ENGINE SHELL =====

@app.route("/holo-game-engine")
def holo_game_engine():
    body = """
    <div class="hero">
      <h1>Holographic Game Engine</h1>
      <p>Mission zones, multiplayer logic, and real-time rendering hooks.</p>
    </div>

    <div class="card">
      <div class="grid">
        <a class="smallbtn" href="/open-world">Open World</a>
        <a class="smallbtn" href="/missions-pro">Missions</a>
        <a class="smallbtn" href="/games-pro-v2">Games</a>
        <a class="smallbtn" href="/xp-center">XP System</a>
      </div>
    </div>
    """
    return _ultra_shell("Game Engine", body)

# ===== LAG OPTIMIZATION LAYER =====

@app.route("/lag-buster")
def lag_buster():
    body = """
    <div class="hero">
      <h1>Quantum Lag Buster</h1>
      <p>Optimized rendering, preloading, and streaming performance layer.</p>
    </div>

    <div class="card">
      <div class="triple">
        <div class="tile">
          <h3>Preload Engine</h3>
          <p>Loads assets before user navigation.</p>
        </div>
        <div class="tile">
          <h3>Async Render</h3>
          <p>Non-blocking UI and background loading.</p>
        </div>
        <div class="tile">
          <h3>Smart Streaming</h3>
          <p>Only loads visible content for speed.</p>
        </div>
      </div>
    </div>
    """
    return _ultra_shell("Lag Buster", body)
