...
@app.route("/aam-deep-search")
def aam_deep_search():
    return page("AAM Deep Search", (
        section("AAM Deep Search", [
            "Natural-language platform search",
            "Cross-module discovery",
            "Marketplace, university, ministry, logistics, finance, and media search",
            "Knowledge retrieval layer"
        ]) +
        section("What This Does", [
            "Acts like a deep-search assistant across the ecosystem",
            "Helps users find modules, services, and knowledge quickly",
            "Moves the platform toward an intelligent search engine"
        ])
    ))

@app.route("/aam-reasoning-assistant")
def aam_reasoning_assistant():
    return page("AAM Reasoning Assistant", (
        section("AAM Reasoning Assistant", [
            "Long-form reasoning support",
            "Architecture analysis",
            "Business and platform planning",
            "Strategy and decision support"
        ]) +
        section("What This Does", [
            "Acts like a high-level thinking assistant for the ecosystem",
            "Helps with planning, system design, and decisions",
            "Moves the platform toward a stronger AI command layer"
        ])
    ))

@app.route("/aam-research-copilot")
def aam_research_copilot():
    return page("AAM Research Copilot", (
        section("AAM Research Copilot", [
            "Research guidance",
            "Cross-platform knowledge support",
            "Planning and synthesis assistance",
            "Creator, ministry, education, logistics, and finance support"
        ]) +
        section("What This Does", [
            "Helps users research and connect ideas across the platform",
            "Combines discovery, analysis, and planning support"
        ])
    ))

@app.route("/aam-knowledge-engine")
def aam_knowledge_engine():
    return page("AAM Knowledge Engine", (
        section("AAM Knowledge Engine", [
            "Unified knowledge layer",
            "Module discovery engine",
            "Retrieval and indexing direction",
            "Foundation for future memory and analytics"
        ]) +
        section("What This Does", [
            "Creates the knowledge backbone for the ecosystem",
            "Supports future search, memory, and AI orchestration improvements"
        ])
    ))
