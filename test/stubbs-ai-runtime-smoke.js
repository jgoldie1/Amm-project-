...
(async()=>{
  ...
  const critic=await serve((_req,res)=>json(res,200,{answer:'Independent verification agrees',confidence:.92,evidenceIds:['source:2'],conclusionKey:'candidate-ok'}));
  ...
  executive.close();critic.close();sandbox.close();
