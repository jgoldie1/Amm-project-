...
assert.strictEqual(reference.compilerInput, false, 'Street View imagery must never be a geometry compiler input');
assert.strictEqual(reference.machineInterpretation, false, 'Street View machine interpretation must remain disabled');
assert.strictEqual(reference.deriveGeometry, false, 'TRYAMM geometry must not be derived from Street View imagery');
...
console.log('Chicago 77 Neighborhood Compiler, Street View reference policy, gameplay layers and certification smoke checks passed');
