...
const files=[
  ...
  'lib/ip-command-center.js','lib/ip-portfolio.js','lib/ai-legal-compliance.js','lib/regulatory-graph.js','lib/compliance-readiness.js','lib/credential-vault.js','lib/trust-network.js','lib/trust-risk.js','lib/dispute-resolution.js','lib/claims-holds.js','lib/governance-routes.js',
  ...
  'test/marketplace-routes-smoke.js','test/marketplace-order-routes-smoke.js','test/holo-media-transport-smoke.js','test/holographic-runtime-routes-smoke.js','test/warehouse-network-smoke.js','test/warehouse-routing-smoke.js','test/ip-command-center-smoke.js','test/ip-portfolio-smoke.js','test/ai-legal-compliance-smoke.js','test/regulatory-graph-smoke.js','test/compliance-readiness-smoke.js','test/credential-vault-smoke.js','test/trust-network-smoke.js','test/trust-risk-smoke.js','test/dispute-resolution-smoke.js','test/claims-holds-smoke.js','test/governance-routes-smoke.js'
];
let failed=0;
