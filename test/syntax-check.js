...
const files=[
  ...
  'lib/marketplace-routes.js','lib/marketplace-order-routes.js','public/merchant-studio.js','public/marketplace.js','public/marketplace-store.js','public/holo-media-transport.js','public/holo-runtime-demo.js',
  'test/marketplace-routes-smoke.js','test/marketplace-order-routes-smoke.js','test/holo-media-transport-smoke.js','test/holographic-runtime-routes-smoke.js'
];
let failed=0;
