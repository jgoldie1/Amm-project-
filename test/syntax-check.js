...
const files=[
  ...
  'lib/holographic-internet.js','lib/holographic-display-capabilities.js','lib/multiview-3d.js','lib/quantum-audio-scene.js','lib/holo-tv-platform.js','lib/holo-room-orchestrator.js','lib/holo-multiuser-room.js','lib/spatial-continuity.js','lib/holo-presence.js','lib/volumetric-presence.js','lib/holographic-runtime.js','lib/holographic-runtime-routes.js','lib/holo-ice-routes.js',
  'lib/marketplace-routes.js','lib/marketplace-order-routes.js','lib/warehouse-network.js','lib/warehouse-routing.js',
  'lib/ip-command-center.js','lib/ip-portfolio.js','lib/ai-legal-compliance.js','lib/regulatory-graph.js','lib/compliance-readiness.js','lib/credential-vault.js','lib/trust-network.js','lib/trust-risk.js','lib/dispute-resolution.js','lib/claims-holds.js','lib/governance-routes.js','lib/platform-readiness.js','lib/domain-events.js',
  ...
  'test/marketplace-routes-smoke.js','test/marketplace-order-routes-smoke.js','test/holo-media-transport-smoke.js','test/holographic-runtime-routes-smoke.js','test/warehouse-network-smoke.js','test/warehouse-routing-smoke.js','test/ip-command-center-smoke.js','test/ip-portfolio-smoke.js','test/ai-legal-compliance-smoke.js','test/regulatory-graph-smoke.js','test/compliance-readiness-smoke.js','test/credential-vault-smoke.js','test/trust-network-smoke.js','test/trust-risk-smoke.js','test/dispute-resolution-smoke.js','test/claims-holds-smoke.js','test/governance-routes-smoke.js','test/platform-readiness-smoke.js','test/domain-events-smoke.js'
];
let failed=0;
