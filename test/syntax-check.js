...
const files=[
  ...
  'test/marketplace-routes-smoke.js','test/marketplace-order-routes-smoke.js','test/holo-media-transport-smoke.js','test/holographic-runtime-routes-smoke.js','test/warehouse-network-smoke.js','test/warehouse-routing-smoke.js','test/ip-command-center-smoke.js','test/ip-portfolio-smoke.js','test/ai-legal-compliance-smoke.js','test/regulatory-graph-smoke.js','test/compliance-readiness-smoke.js','test/credential-vault-smoke.js','test/trust-network-smoke.js','test/trust-risk-smoke.js','test/dispute-resolution-smoke.js','test/claims-holds-smoke.js','test/governance-routes-smoke.js','test/platform-readiness-smoke.js','test/domain-events-smoke.js','test/distinguished-hardening-smoke.js','test/faith-calendar-smoke.js'
];
let failed=0;
