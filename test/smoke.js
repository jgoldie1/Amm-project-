...
for(const feature of ['One world. Every scale. Every opportunity.','Creator and business economy','Live now','Safety Center','manifest.webmanifest']) assert(shell.includes(feature),`${feature} missing from app shell`);
