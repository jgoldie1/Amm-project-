...
const APP_SHELL=['/','/styles.css','/app.js','/app-shell.html','/app-shell.css','/app-shell.js','/judah-splash.css','/judah-splash.js','/spaceverse.html','/spaceverse.css','/spaceverse.js','/spaceverse-engine.js','/vendor/model-viewer.min.js','/manifest.webmanifest','/community-rules.html','/icons/judah-192.png','/icons/judah-512.png','/media/tryamm-judah-splash-poster-v2.jpg','/media/tryamm-spaceverse-launch-poster-v1.jpg','/media/venus-map-web.webp'];
