'use strict';
const CACHE='tryamm-shell-v17-hologpt';
...
function injectHoloGPT(html){
  ...
  const css='<link rel="stylesheet" href="/hologpt-widget.css?v=1" data-hologpt-global="true">';
  const js='<script src="/hologpt-widget.js?v=1" defer data-hologpt-global="true"></script>';
