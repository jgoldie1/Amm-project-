...
(() => {
  ...
  class SpaceVerseEngine {
    constructor(canvas) {
      this.canvas=canvas; this.world="time"; this.running=false; this.startedAt=0; this.elapsed=0; this.altitude=250;
